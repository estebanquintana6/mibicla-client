...
const ContactForm = () => {
    return (
        <section className="h-screen bg-gradient-to-r from-gray-800 to-black p-[36px] flex">
            <div className="xs:m-0 md:mx-auto md:my-auto bg-black bg-opacity-70 p-4 rounded-xl xs:w-full md:w-2/5">
